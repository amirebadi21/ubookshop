...
></img>
       ...
       <f-csb style={{width:"200px",direction:"ltr",paddingLeft:5 , height:40}}>
        ...
        {props.state.cart.includes(props.book.title)?null:<img src="https://cdn.ituring.ir/research/92/shopping.png"
         style={{width:"40px",height:"40px",objectFit:"contain" ,paddingRight:10 }} ></img>}
         
       {props.state.cart.includes(props.book.title)?   <img src="https://cdn.ituring.ir/research/92/images%20%281%29.png" 
